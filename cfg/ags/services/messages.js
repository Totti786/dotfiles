...
const FIRST_RUN_NOTIF_BODY = `First run? 👀 <span foreground="#FF0202" font_weight="bold">SUPER+Shift+W</span> to pick a wallpaper (or styles will break!)\nFor a list of keybinds, hit <span foreground="#c06af1" font_weight="bold">Super + /</span>.`;

export async function firstRunWelcome() {
    GLib.mkdir_with_parents(`${GLib.get_user_state_dir()}/ags/user`);
