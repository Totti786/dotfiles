...
external_menu="rofi -dmenu -p "YouTube" -a -theme ~/.config/rofi/themes/launcher1.rasi" 


#external_menu= "dmenu_run -nb "$color0" -nf "$color15" -sb "$color1" -sf "$color15" -i -l 30 -p Search: "
